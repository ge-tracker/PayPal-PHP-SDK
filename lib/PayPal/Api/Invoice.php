...
class Invoice extends PayPalResourceModel
{
     ...
     * @return $this
     */
    public function setMerchantInfo($merchant_info): self
    {
     ...
     * @return $this
     */
    public function addBillingInfo($billingInfo): ?self
    {
     ...
     * @return $this
     */
    public function removeBillingInfo($billingInfo): self
    {
        return $this->setBillingInfo(
     ...
     * @return $this
     */
    public function setCcInfo($cc_info): self
    {
     ...
     * @return $this
     */
    public function addCcInfo($participant): ?self
    {
        if (!$this->getCcInfo()) {
     ...
     * @return $this
     */
    public function removeCcInfo($participant): self
    {
        return $this->setCcInfo(
     ...
     * @return $this
     */
    public function addItem($invoiceItem): ?self
    {
        if (!$this->getItems()) {
     ...
     * @return $this
     */
    public function removeItem($invoiceItem): self
    {
        return $this->setItems(
     ...
     * @return $this
     */
    public function setPaymentTerm($payment_term): self
    {
     ...
     */
    public function getCustom(): CustomAmount
    {
        return $this->custom;
    }
     ...
     * @return $this
     */
    public function setAllowPartialPayment($allow_partial_payment): self
    {
     ...
     * @return $this
     */
    public function setMinimumAmountDue($minimum_amount_due): self
    {
     ...
     */
    public function getMinimumAmountDue(): Currency
    {
     ...
     * @return $this
     */
    public function setTaxCalculatedAfterDiscount($tax_calculated_after_discount): self
    {
     ...
     * @return bool
     */
    public function getTaxCalculatedAfterDiscount(): bool
    {
     ...
     * @return $this
     */
    public function setTaxInclusive($tax_inclusive): self
    {
     ...
     * @return $this
     */
    public function setMerchantMemo($merchant_memo): self
    {
     ...
     * @return $this
     */
    public function setLogoUrl($logo_url): self
    {
     ...
     * @return $this
     */
    public function addPayment($paymentDetail): ?self
    {
        if (!$this->getPayments()) {
     ...
     * @return $this
     */
    public function removePayment($paymentDetail): self
    {
        return $this->setPayments(
     ...
     * @return $this
     */
    public function setRefunds($refunds): self
    {
     ...
     * @return $this
     */
    public function addRefund($refundDetail): ?self
    {
        if (!$this->getRefunds()) {
     ...
     * @return $this
     */
    public function removeRefund($refundDetail): self
    {
        return $this->setRefunds(
     ...
     */
    public function getPaidAmount(): PaymentSummary
    {
     ...
     * @return $this
     */
    public function setRefundedAmount($refunded_amount): self
    {
     ...
     * @return \PayPal\Api\PaymentSummary
     */
    public function getRefundedAmount(): PaymentSummary
    {
     ...
     * @return $this
     */
    public function addAttachment($fileAttachment): ?self
    {
     ...
     * @return $this
     */
    public function removeAttachment($fileAttachment): self
    {
        return $this->setAttachments(
     ...
     * @return Invoice
     */
    public function create($apiContext = null, $restCall = null): Invoice
    {
        $payLoad = $this->toJSON();
     ...
     */
    public static function search($search, $apiContext = null, $restCall = null): InvoiceSearchResponse
    {
     ...
     * @return Invoice
     */
    public static function get($invoiceId, $apiContext = null, $restCall = null): Invoice
    {
     ...
     * @return InvoiceSearchResponse
     */
    public static function getAll($params = array(), $apiContext = null, $restCall = null): InvoiceSearchResponse
    {
     ...
     * @return Invoice
     */
    public function update($apiContext = null, $restCall = null): Invoice
    {
        ArgumentValidator::validate($this->getId(), "Id");
        $payLoad = $this->toJSON();
        $json = self::executeCall(
     ...
     * @return Image
     */
    public static function qrCode($invoiceId, $params = array(), $apiContext = null, $restCall = null): Image
    {
        ArgumentValidator::validate($invoiceId, 'invoiceId');
        ArgumentValidator::validate($params, 'params');
     ...
     */
    public static function generateNumber($apiContext = null, $restCall = null): InvoiceNumber
    {
        $payLoad = "";
        $json = self::executeCall(
