...
class Capture extends PayPalResourceModel
{
     ...
     * @return $this
     */
    public function setIsFinalCapture($is_final_capture): self
    {
     ...
     * @return Capture
     */
    public static function get($captureId, $apiContext = null, $restCall = null): Capture
    {
     ...
     */
    public function refundCapturedPayment($refundRequest, $apiContext = null, $restCall = null): DetailedRefund
    {
        ArgumentValidator::validate($this->getId(), "Id");
