...
class PayerInfo extends PayPalModel
{
     ...
     * @return $this
     */
    public function setBuyerAccountNumber($buyer_account_number): self
    {
     ...
     * @return $this
     */
    public function setPhoneType($phone_type): self
    {
     ...
     * @return $this
     */
    public function setTaxIdType($tax_id_type): self
    {
