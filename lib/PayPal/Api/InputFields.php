...
class InputFields extends PayPalModel
{
     ...
     * @return $this
     */
    public function setAllowNote($allow_note): self
    {
     ...
     * @return bool
     */
    public function getAllowNote(): bool
    {
     ...
     * @return $this
     */
    public function setNoShipping($no_shipping): self
    {
     ...
     * @return $this
     */
    public function setAddressOverride($address_override): self
    {
     ...
     * @return int
     */
    public function getAddressOverride(): int
    {
