...
class BillingAgreementsFunctionalTest extends TestCase
{
     ...
     * @return Agreement
     */
    public function testCreatePayPalAgreement(): Agreement
    {
     ...
     * @return Agreement
     */
    public function testExecute($agreement): Agreement
    {
        ...
        self::assertNotEmpty($paymentToken);
     ...
     * @return Agreement
     */
    public function testCreateCCAgreement(): Agreement
    {
        $plan = BillingPlansFunctionalTest::getPlan();
        $request = $this->operation['request']['body'];
        $agreement = new Agreement($request);
     ...
     * @return Plan
     */
    public function testGet($agreement): Plan
    {
        $result = Agreement::get($agreement->getId(), $this->apiContext, $this->mockPayPalRestCall);
        self::assertNotNull($result);
        self::assertEquals($agreement->getId(), $result->getId());
        return $result;
    }
     ...
     * @return Agreement
     */
    public function testSetBalance($agreement): Agreement
    {
        self::markTestSkipped('Skipped as the fix is on the way.');
     ...
     * @return Agreement
     */
    public function testBillBalance($agreement): Agreement
    {
        self::markTestSkipped('Skipped as the fix is on the way.');
     ...
     * @return Agreement
     */
    public function testGetTransactions($agreement): ?Agreement
    {
    ...
    public function testSuspend($agreement)
    {
        ...
        self::assertTrue($result);
        self::assertEquals('Suspended', $get->getState());
        return $get;
    }
    ...
    public function testReactivate($agreement)
    {
        ...
        $get = $this->testGet($agreement);
        self::assertEquals('Active', $get->getState());
        return $get;
    }
    ...
    public function testCancel($agreement)
    {
        ...
        $get = $this->testGet($agreement);
        self::assertEquals('Cancelled', $get->getState());
        return $get;
    }
}
