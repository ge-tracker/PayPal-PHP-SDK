...
class TemplateSettingsMetadataTest extends TestCase
{
     ...
     */
    public static function getObject(): TemplateSettingsMetadata
    {
     ...
     * @return TemplateSettingsMetadata
     */
    public function testSerializationDeserialization(): TemplateSettingsMetadata
    {
    ...
    {
        self::assertEquals($obj->getHidden(), true);
    }
}
